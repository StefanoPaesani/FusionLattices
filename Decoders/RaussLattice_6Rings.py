...
from LatticeFunctions.FusionRaussendorf_6Rings import FusionLattice_Raussendorf_6Rings
...
if __name__ == '__main__':
    ...
    plt.legend()
    plt.savefig(os.path.join(saving_folder, 'RaussLattice_6ring_lossonly.png'))
    ...
    for L_ix, L in enumerate(L_list):
        print('   Doing L=', L)
        this_data = \
            decoder_successprob_error_vs_loss_list_parallelized(err_vs_eras_vals, L,
    ...
    plt.ylabel("Logical error rate")
    plt.legend()
    plt.savefig(os.path.join(saving_folder, 'RaussLattice_6ring_errorsonly.png'))
    ...
    #                              'PlotDuring2DScan_RaussLattice6Rings_scan'+str(scan_ix)+'of'+str(num_scans)+'.png'))
    #
    # file_name = 'error_vs_erasure_Raussendorf6Rings_Lmax' + str(max(L_list)) + '_numlosstrials' + str(
