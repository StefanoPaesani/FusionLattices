...
if __name__ == '__main__':
    ...
    plt.legend()
    plt.savefig(os.path.join(saving_folder, 'FFCCLattice_lossonly.png'))
    ...
    plt.ylabel("Logical error rate")
    plt.legend()
    plt.savefig(os.path.join(saving_folder, 'FFCCLattice_errorsonly.png'))

    ######################################################################
    ####### Full 2D scan with losses & errors - adding more scans, and saving at every scan
    ######################################################################
    ...
    #                              'PlotDuring2DScan_FFCCLattice_scan'+str(scan_ix)+'of'+str(num_scans)+ '_logopaxis_' + log_op_dir +'.png'))
    #
    # file_name = 'error_vs_erasure_FFCCLattice_Lmax' + str(max(L_list))+ '_logopaxis_' + log_op_dir + '_numlosstrials' + str(
